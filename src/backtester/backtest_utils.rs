...
//     println!("INFO BEFORE SIM: {}", liquidity_array.current_tick);
...
//                     let adjusted_amount = if swap_data.token_in == pool_model.token_a_address {
//                         U256::from(
//                             (swap_data.amount_in
...
//                     } else {
//                         U256::from(
//                             (swap_data.amount_out * 10.0f64.powf(pool_model.token_a_decimals as f64))
//                                 as u128,
//                         )
//                     };
...
//                     // MUST CORRESPOND TO TICK (-17354) since thats where it ended last time. the PRICE is 176.344
//                     amount_in: 176.344,
//                     amount_out: 1.0,
//                 }),
//             }],
...
//         // println!("LIQ ARR: {}", final_liquidity_array.current_tick);
//         println!("NMR 2 IS STARTING");
